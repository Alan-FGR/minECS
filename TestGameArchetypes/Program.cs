...
public class TestGame : Game
{
    ...
    public TestGame()
    {
        ...
        registry_.RegisterComponent<Velocity>();
        registry_.RegisterComponent<Dimensions>();
        registry_.RegisterComponent<Sprite>();
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        registry_.Loop((EntityData entIdx, ref Sprite sprite, ref Position position) =>
        {
